...
//   | tags                | text (ik) + .keyword | 标签，text 用于全文搜索，.keyword 用于精确聚合 |
...
//   | text                | text (ik) | OCR 提取的文本内容，支持全文搜索          |
...
//   | address             | text (ik) | 详细地址（Amap 逆地理编码）               |
//   | formatted_address   | text (ik) | 格式化地址（Amap 逆地理编码）             |
//
